    ...
    <section className="mx-auto max-w-4xl px-margin-mobile py-24 md:px-margin-desktop">
      <article className="industrial-border bg-white p-12 shadow-sm">
        ...
        <div className="font-body-lg space-y-6 text-body-lg leading-relaxed text-on-surface-variant">
          <p>
            The landscape of European logistics is undergoing a tectonic shift with the introduction
            of <strong>Regulation (EU) 2025/40</strong>, also known as the Packaging and Packaging
            Waste Regulation (PPWR). This landmark legislation aims to drastically reduce the
            environmental footprint of logistics operations by mandating stricter void-space ratios.
          </p>
          ...
          <div className="mt-8 border-l-4 border-secondary-container bg-surface-container p-6 italic">
            &quot;The shift from voluntary efficiency to regulatory mandate means that box
